...
require_relative "lib/selenium_download_helper/version"

Gem::Specification.new do |spec|
  spec.name          = "selenium_download_helper"
  spec.version       = SeleniumDownloadHelper::VERSION
  spec.authors       = ["aki77"]
  spec.email         = ["aki77@users.noreply.github.com"]

  spec.summary       = "Selenium download helper."
